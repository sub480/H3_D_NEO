...
Files:
  ...
  ``seg_XXXX_facepre.mp4`` — before FaceRefine stitch, when enabled
    ...
    *,
    ...
    try:
        ...
        log.info(
            ...
            int(seg.index) + 1,
            "first-pass " if suffix == "pre" else "pre-face " if suffix == "facepre" else "",
            path,
        )
        return str(path)
...
def maybe_export_segment_mp4s(
    ...
    *,
    ...
    """Write final clip, first-pass, and optional pre-FaceRefine clip."""
    paths: list[str] = []
